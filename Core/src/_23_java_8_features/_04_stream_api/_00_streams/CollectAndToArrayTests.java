...
public class CollectAndToArrayTests {
	...
	private static void testCollect() {
		...
		// Add 3 to every element and get statistics
		...
		// Get sum all even numbers using IntSummaryStatistics
		...
		// Get list of strings without duplicates
